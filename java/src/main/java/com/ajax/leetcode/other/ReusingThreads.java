...
public class ReusingThreads {
    private static final Logger LOGGER = Logger.getLogger(ReusingThreads.class.getName());
    ...
    public static void main(String[] args) {
        ...
        /*
         * Will submit 10 tasks. Note that there's only 5 threads to run all of them in our thread pool.
         * So the first 5 tasks will run simultaneously and 5 tasks will wait in the queue until a thread is available.
         */
